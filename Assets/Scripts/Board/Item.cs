...
public class Item
{
	...
	// Comment: Thêm các thuộc tính để lưu vị trí ban đầu của vật phẩm
	public int InitialBoardX { get; private set; }
	public int InitialBoardY { get; private set; }
	...
	// Comment: Thêm phương thức để lưu vị trí ban đầu khi vật phẩm được tạo
